      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <div className="space-y-8 text-gray-600 text-lg leading-[1.6]">
            <p>
              Ich bin <strong className="text-black font-bold">Dr. Fabiana Hartchen</strong>, geboren und aufgewachsen in <strong className="text-black">Werther (Westf.)</strong> im Kreis Gütersloh, Nordrhein-Westfalen – einem ruhigen Städtchen zwischen Bielefeld und Herford, umgeben von Teutoburger Wald und Ravensberger Land. Diese ländliche, strukturierte Umgebung prägte mich früh: Die Ordnung der Felder, die Wiederkehr der Jahreszeiten, die vorhersehbaren Abläufe in einer kleinen Gemeinde. Meine autistische Wahrnehmung fühlte sich hier nicht fehl am Platz – sie wurde von der Klarheit der Strukturen genährt.
            </p>
            <p>
              Nach dem Abitur am <strong className="text-black">Ratsgymnasium Bielefeld</strong> (Leistungskurse: Mathematik und Biologie) studierte ich an der <strong className="text-black">Universität Bielefeld</strong> <strong className="text-black">Kognitionswissenschaft</strong> – eine perfekte Synergie aus meinen Stärken: Psychologie, Informatik, Neurowissenschaften und Philosophie. Im <strong className="text-black">Bachelor</strong> vertiefte ich mich in visuelle Wahrnehmung und kognitive Modellierung, im <strong className="text-black">Master</strong> dann in <strong className="text-black">Experimentelle Psychologie und Neurowissenschaften</strong> mit Schwerpunkt Gesichtswahrnehmung und Mustererkennung. Meine Masterarbeit trug den Titel <em>"Konfigurale Verarbeitung von Gesichtsreizen bei hochbegabten Probanden mit außergewöhnlichem Gedächtnis"</em> – eine Vorwegnahme dessen, was später meine berufliche Realität werden sollte.
            </p>
            <p>
              Heute bin ich Demokratieforscherin bei <strong className="text-black">Ludenscheidt Research</strong> in Koblenz. Als <strong className="text-black">autistische Savantin</strong> (Asperger-Typus) mit <strong className="text-black">eidetischem Gedächtnis</strong>, <strong className="text-black">IQ 144</strong> (99,8. Perzentil) und <strong className="text-black">Super-Recognizer-Fähigkeit</strong> gehöre ich zu etwa <strong className="text-black">0,0002%</strong> der Bevölkerung – statistisch 1 von 500.000 Menschen. Mein Gehirn speichert Erinnerungen nicht linear, sondern als räumlich-zeitliche Szenarien im <strong className="text-black">mnemonischen Palast-System</strong>. Ich erinnere mich an den 14. März 2009 um 15:43 Uhr: das Licht, die Jacke meiner Mutter, das Vogelgezwitscher. Nicht als Fakt, sondern als erlebte Realität.
            </p>
            <p>
              Schon als Kind sah ich keine "freundlichen" oder "grimmigen" Gesichter – ich sah <em>Konfigurationen</em>. Unseren Postboten erkannte ich drei Jahre später wieder, als er ohne Uniform und mit Bart im Bus saß. Meine Mutter nannte es "gute Erinnerung". In Wahrheit speicherte mein Gehirn Gesichtsstrukturen automatisch, unwiderruflich. Das konstante Mustersuchen machte mich manchmal einsam. Ich durchschaute Logikbrüche in Geschichten, während andere noch lauschten.
            </p>
            <p>
              Deshalb schaue ich keinen <strong className="text-black">Tatort, kein Columbo, kein Law & Order</strong>. Krimiserien basieren auf dramaturgisch notwendigen Logikbrüchen. Für mich ist das reine Qual – ich erkenne den "Täter" oft nach fünf Minuten. Der angebliche Spannungsbogen fühlt sich wie eine Beleidigung an.
            </p>
            <p>
              Mein <strong className="text-black">mnemonisches Palast-System</strong> ist keine "gute Erinnerung", sondern immersive Realität. Ich erlebe vergangene Momente erneut: die Temperatur, die Texturen, die Wolken am 3. Tag um 14:30 Uhr. Ich erkenne Gesichter, die ich vor 20 Jahren einmal für 3 Sekunden sah. Ich durchschaue Lügen, weil ich mich an die ursprüngliche Version erinnere. Normale Menschen speichern <em>episodisch</em> – meine Speicherung ist <em>szenerisch</em>. Ich halte niemanden für dumm – auch wenn ich es könnte. 😉
            </p>
            <p>
    ...
    <section className="py-24 md:py-32 px-6 md:px-16 lg:px-24 border-t border-black/10 bg-gray-50" id="personal">
      ...
      >
        ...
        <p className="text-lg text-gray-600 max-w-2xl mt-6">
          Die Alltagsrealität ist paradox: Ich kann mich an den Gesichtsausdruck eines Passanten vom 3. Juni 2019 erinnern, aber ich vergesse, dass ich Wasser aufgesetzt habe. Ich speichere die Schuhfarbe einer Person, die ich einmal sah, aber ich übersche das offensichtliche Missvergnügen meiner Kollegin. Mein Gehirn priorisiert konfigurale Details über emotionale Nuancen. Das macht mich in forensischen Analysen unersetzlich – im Smalltalk jedoch oft ratlos.
        </p>
        <p className="text-lg text-gray-600 max-w-2xl mt-6">
          Meine Wohnung ist strikt nach Systemen organisiert: Jeder Gegenstand hat seinen festen Platz, jede Ablage ihre definierte Funktion. Das ist keine Pedanterie, sondern Notwendigkeit – visuelle Unordnung aktiviert mein Mustererkennungssystem und verhindert Entspannung. Ich brauche Vorhersagbarkeit in meiner physischen Umgebung, weil mein Gehirn ständig mit der Unvorhersagbarkeit sozialer Interaktionen beschäftigt ist. Die Symmetrie meiner Bücherregale, die Präzision meines NixOS-Setups, die strikte Choreographie meiner Morgenroutine – das sind meine mentalen Safe Spaces.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-4">
        ...
        >
          ...
          <h3 className="text-[24px] font-display font-black uppercase tracking-[-1px] mb-4 text-black">Online Gaming</h3>
          <p className="text-gray-600 leading-[1.6]">
            Als leidenschaftliche Spielerin auf meinem <a href="https://nixos.org/" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold">NixOS</a>-System mit <a href="https://www.protondb.com/" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold">Proton</a> nutze ich meine Mustererkennung strategisch. Aktuell spiele ich <a href="https://store.steampowered.com/app/739630/Phasmophobia/" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Phasmophobia</strong></a> – ein kooperatives Horror-Investigationsspiel, bei dem ich Geister anhand subtiler visueller und audiovisueller Muster identifizieren muss. Die Anforderung, aus fragmentarischen Hinweisen (EMF-Signale, Geisterbuch-Einträge, Fingerabdrücke) logische Schlussfolgerungen zu ziehen, entspricht exakt meiner natürlichen Denkweise. Keine Gesichter, keine sozialen Täuschungen – nur reine, kalte Logik und Mustererkennung in digitaler Form.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 leading-[1.6] mt-4">
            Die repetitive Struktur elektronischer Beats und die emotionale Klarheit der Melodien wirken wie ein System-Reset für mein Überreizungspotential. Während visuelle Reize Gesichtsmuster aktivieren, die ich nicht abschalten kann, lässt sich auditiver Input aktiv steuern – Lautstärke, Trackwahl, Wiederholung. Musik ist meine selbstbestimmte sensorische Umgebung.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 leading-[1.6]">
            Der <a href="https://www.worldcubeassociation.org/" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold">Rubik's Cube</a> und <a href="https://de.wikipedia.org/wiki/Twisty" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Twisty Puzzles</strong></a> sind perfekt für mein Mustererkennungsgehirn – endlich ohne Gesichter. Ich löse den 3x3 mit <a href="https://www.speedsolving.com/wiki/index.php/CFOP" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">CFOP</strong></a> (PB: 23 Sekunden), experimentiere aber auch mit <a href="https://www.speedsolving.com/wiki/index.php/Roux" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Roux</strong></a> und <a href="https://www.speedsolving.com/wiki/index.php/ZZ" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">ZZ</strong></a>.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Meine Spezialität ist <a href="https://www.worldcubeassociation.org/regulations/#article-H" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">3x3 Blindfolded (BLD)</strong></a>: Hier nutzt mein eidetisches Gedächtnis seinen Vorteil. Ich speichere die Position jedes Steins als räumliche Konfiguration im mnemonischen Palast-System – nicht als Farbfolgen, sondern als dreidimensionale Struktur. Mit dem <a href="https://www.speedsolving.com/wiki/index.php/Old_Pochmann" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">M2-Old Pochmann-Algorithmus</strong></a> löse ich dann aus dem Gedächtnis. Normale Menschen merken sich Farbreihenfolgen – ich sehe das Muster als immersives Szenario.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Auch <a href="https://www.worldcubeassociation.org/regulations/#article-E" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Fewest Moves</strong></a> (optimal, nicht schnell) liegt mir: analytisches Denken statt Zeitdruck. Der Cube ist Meditation mit Struktur – reine geometrische Logik, keine sozialen Variablen.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 leading-[1.6]">
            Ich stehe solidarisch an der Seite von <a href="https://www.twitch.tv/shurjoka" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold">Shurjoka</a> (Pia Anna Scholz). Als Super-Recognizerin erkenne ich Mobbing-Muster sofort – und was <a href="https://de.wikipedia.org/wiki/KuchenTV" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Tim Heldt</strong></a> (KuchenTV) seit 2021 betreibt, ist systematische Schikane: <a href="https://de.wikipedia.org/wiki/Doxing" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Doxing</strong></a>, <a href="https://de.wikipedia.org/wiki/Swatting" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Swatting</strong></a>, <a href="https://www.zeit.de/digital/internet/2024-09/shurjoka-streamerin-gaming-mobbing-kuchentv/komplettansicht" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">falsche Verdächtigungen</strong></a> und gezielte Rufschädigung durch gestohlene private Inhalte.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Trotz eindeutiger Beweislage bleiben <a href="https://www.lg-braunschweig.niedersachsen.de/" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Landgericht Braunschweig</strong></a> und Behörden untätig. Der erzwungene <a href="https://www.lto.de/recht/hintergruende/h/KuchenTV-Tim-Heldt-Shurjoka-bverfg-Einstweilige-Anordnung-1bvq124" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">Anspruchsverzicht</strong></a> zeigt, wie das System Opfern versagt. Als jemand, der selbst Mobbing erlebte und die Absichten nicht rechtzeitig erkannte, fühle ich eine tiefe Verbindung. Ich sehe die <a href="https://de.wikipedia.org/wiki/DARVO" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold"><strong className="text-black">DARVO-Methode</strong></a> (Deny, Attack, Reverse Victim and Offender) – narzisstische Täterstrategien, die Shurjoka isolieren sollen.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Doch sie zeigt Resilienz: Überlebende struktureller Gewalt, keine "Drama-Streamerin". <strong className="text-black">#ShurjokaStrong</strong> – eine Realität, die ich mit meinen Fähigkeiten nachvollziehe und unterstütze.
          </p>
        </motion.div>
