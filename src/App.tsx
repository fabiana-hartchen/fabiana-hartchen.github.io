    ...
    <section className="py-24 md:py-32 px-6 md:px-16 lg:px-24 border-t border-black/10 bg-gray-50" id="personal">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-4">
        ...
        >
          ...
          <p className="text-gray-600 leading-[1.6]">
            Der <a href="https://www.worldcubeassociation.org/" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold">Rubik's Cube</a> und <strong className="text-black">Twisty Puzzles</strong> sind perfekt für mein Mustererkennungsgehirn – endlich ohne Gesichter. Ich löse den 3x3 mit <strong className="text-black">CFOP</strong> (PB: 23 Sekunden), experimentiere aber auch mit <strong className="text-black">Roux</strong> und <strong className="text-black">ZZ</strong>.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Meine Spezialität ist <strong className="text-black">3x3 Blindfolded (BLD)</strong>: Hier nutzt mein <strong className="text-black">eidetisches Gedächtnis</strong> seinen Vorteil. Ich speichere die Position jedes Steins als räumliche Konfiguration im mnemonischen Palast-System – nicht als Farbfolgen, sondern als dreidimensionale Struktur. Mit dem <strong className="text-black">M2-Old Pochmann-Algorithmus</strong> löse ich dann aus dem Gedächtnis. Normale Menschen merken sich Farbreihenfolgen – ich sehe das Muster als immersives Szenario.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Auch <strong className="text-black">Fewest Moves</strong> (optimal, nicht schnell) liegt mir: analytisches Denken statt Zeitdruck. Der Cube ist Meditation mit Struktur – reine geometrische Logik, keine sozialen Variablen.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 leading-[1.6]">
            Ich stehe solidarisch an der Seite von <a href="https://www.twitch.tv/shurjoka" target="_blank" rel="noreferrer" className="text-black hover:text-brand underline decoration-black/30 underline-offset-4 font-semibold">Shurjoka</a> (Pia Anna Scholz). Als Super-Recognizerin erkenne ich Mobbing-Muster sofort – und was <strong className="text-black">Tim Heldt</strong> (KuchenTV) seit 2021 betreibt, ist systematische Schikane: <strong className="text-black">Doxing</strong>, <strong className="text-black">Swatting</strong>, <strong className="text-black">falsche Verdächtigungen</strong> und gezielte Rufschädigung durch gestohlene private Inhalte.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
            Trotz eindeutiger Beweislage bleiben <strong className="text-black">Landgericht Braunschweig</strong> und Behörden untätig. Der erzwungene <strong className="text-black">Anspruchsverzicht</strong> zeigt, wie das System Opfern versagt. Als jemand, der selbst Mobbing erlebte und die Absichten nicht rechtzeitig erkannte, fühle ich eine tiefe Verbindung. Ich sehe die <strong className="text-black">DARVO-Methode</strong> (Deny, Attack, Reverse Victim and Offender) – narzisstische Täterstrategien, die Shurjoka isolieren sollen.
          </p>
          <p className="text-gray-600 leading-[1.6] mt-4">
