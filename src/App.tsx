      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <div className="space-y-8 text-gray-600 text-lg leading-[1.6]">
            <p>
              Ich bin <strong className="text-black font-bold">Dr. Fabiana Hartchen</strong>, Demokratieforscherin bei <strong className="text-black">Ludenscheidt Research</strong> in Koblenz. Als <strong className="text-black">autistische Savantin</strong> (Asperger-Typus) mit <strong className="text-black">eidetischem Gedächtnis</strong>, <strong className="text-black">IQ 144</strong> (99,8. Perzentil) und <strong className="text-black">Super-Recognizer-Fähigkeit</strong> gehöre ich zu etwa <strong className="text-black">0,0002%</strong> der Bevölkerung – statistisch 1 von 500.000 Menschen. Mein Gehirn speichert Erinnerungen nicht linear, sondern als räumlich-zeitliche Szenarien im <strong className="text-black">mnemonischen Palast-System</strong>. Ich erinnere mich an den 14. März 2009 um 15:43 Uhr: das Licht, die Jacke meiner Mutter, das Vogelgezwitscher. Nicht als Fakt, sondern als erlebte Realität.
            </p>
            <p>
